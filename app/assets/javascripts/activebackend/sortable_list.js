var create_sortable_list = function(options){
    ordered_list = {
        ...
        , enable_reordering: function(e) {
            ...
            $('*:not("#reorder_action_done, #reorder_action, .sortable_list")').not(this.list.reorder_action_done.children()).not($('.sortable_list').parents()).not($('.sortable_list').find("*")).not(this.list.reorder_action_done.parents()).fadeTo(500, 0.8);
        ...
        , restore_controls: function(e) {
            this.list.sortable_list.removeClass('reordering');
            $('*:not("#reorder_action_done, #reorder_action")').fadeTo(250, 1);
